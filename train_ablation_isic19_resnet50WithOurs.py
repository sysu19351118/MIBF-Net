...
from model.compare_model import OurClassfier
...
def test(model, test_loader, criterion, device, num_classes=8):
    ...
    return epoch_loss, epoch_acc, 0, 0, precision_list, recall_list, f1_list, conf_matrix
...
def main():
    ...
    model = OurClassfier(num_labels=8)
