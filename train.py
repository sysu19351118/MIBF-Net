...
from model.ourmodel import OurClassfierConvnext, OurClassfierConvnextV2, OurClassfierConvnextV3, OurClassfierConvnextV4, OurClassfierConvnextV5
...
def main():
    ...
    model = OurClassfierConvnextV5(args, num_labels=7, loss_class=args.loss_type)
