...
import os
import numpy as np
from dataset.dataset import TextImageDatasetTrain, TextImageDatasetTest
from torch.utils.data import DataLoader
from sklearn.metrics import precision_score, recall_score, f1_score, confusion_matrix

from model.SPAWithOurs import SPAWithOur
...
from model.hifuse import HifuseWithOur
from model.compare_model import BaselineOnlytext
import sys
sys.path.append('/mnt/sda1/zzixuantang/classfier_convNext')
...
def main():
    ...
    parser.add_argument('--train_json_path', type=str, default='/mnt/sda1/zzixuantang/classfier_convNext/data/00-HAM10000/04-临床症状-trainset-4o-0.3mel2nv_0207.json', help='Path to training data')
    parser.add_argument('--test_json_path', type=str, default='/mnt/sda1/zzixuantang/classfier_convNext/data/00-HAM10000/04-临床症状-testset-4o-0.3mel2nv_0207.json', help='Path to training data')
    ...
    # 定义数据加载器
    train_dataset = TextImageDatasetTrain(args.train_json_path)
    ...
    test_dataset = TextImageDatasetTest(args.test_json_path)
    test_loader = DataLoader(test_dataset, batch_size=args.batch_size, shuffle=False)

    model = SPAWithOur(num_labels=7, loss_class=args.loss_type)
